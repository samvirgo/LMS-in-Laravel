                 ...
                 <div class="span3">
                     <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                             <li class="active"><a href="{{('/dashboard')}}"><i class="menu-icon icon-home"></i>Home
                                </a></li>
                                       </ul>
                            ...
                            <ul class="widget widget-menu unstyled">
                                 <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-signout">
                                    ...
                                    <ul id="togglePages" class="collapse unstyled">
                                        <li><a href="{{('/issue')}}"><i class="menu-icon icon-repeat"></i>Issue book </a></li>
                                        <li><a href="{{('/return')}}"><i class="menu-icon icon-undo"></i>Return Book </a></li>
                                        
                                    </ul>
                                </li>
                                <li><a href="{{('/issuebook/history')}}"><i class="menu-icon icon-table"></i>Issue Book History </a></li>
